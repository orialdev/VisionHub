...
function GalaxyUI:CreateColorPicker(opt)
	...
	button.Text = opt.Name or "Color Picker"
	button.TextColor3 = GalaxyUI.Themes.Default.TextColor
	button.Font = Enum.Font.Gotham
	button.TextSize = 16
	button.Parent = container
	local colorFrame = Instance.new("Frame")
	colorFrame.Size = UDim2.new(1,0,0,100)
	colorFrame.Position = UDim2.new(0,0,1,2)
	colorFrame.BackgroundColor3 = GalaxyUI.Themes.Default.ButtonColor
	colorFrame.Visible = false
	colorFrame.ZIndex = 50
	local grid = Instance.new("UIGridLayout",colorFrame)
	grid.CellSize = UDim2.new(0,30,0,30)
	grid.CellPadding = UDim2.new(0,5,0,5)
	local colors = opt.Colors or {Color3.fromRGB(255,0,0),Color3.fromRGB(0,255,0),Color3.fromRGB(0,0,255),Color3.fromRGB(255,255,0),Color3.fromRGB(0,255,255),Color3.fromRGB(255,0,255)}
	for i,col in ipairs(colors) do
		local colBtn = Instance.new("TextButton")
		colBtn.Size = UDim2.new(0,30,0,30)
		colBtn.BackgroundColor3 = col
		colBtn.Text = ""
		colBtn.Parent = colorFrame
	...
	container.Parent = opt.Parent or LocalPlayer:WaitForChild("PlayerGui")
	colorFrame.Parent = container
	button.MouseButton1Click:Connect(function()
		colorFrame.Visible = not colorFrame.Visible
	end)
	local o = {Frame = container}
	function o:SetColor(col)
		button.TextColor3 = col
		if opt.Callback then
			opt.Callback(col)
		end
...
function GalaxyUI:RefreshPlayerList(dropdown)
	local playerNames = {}
...
local playerDropdown = GalaxyUI:CreateDropdown({Name = "Players", Options = {}})
GalaxyUI:RefreshPlayerList(playerDropdown)
local RefreshButton = GalaxyUI:CreateButton({Name = "Refresh List", Callback = function() GalaxyUI:RefreshPlayerList(playerDropdown) end})
return {UI = GalaxyUI, PlayerDropdown = playerDropdown, RefreshButton = RefreshButton}
